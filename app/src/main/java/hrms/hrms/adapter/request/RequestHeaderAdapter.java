...
public class RequestHeaderAdapter extends RecyclerView.Adapter<RequestHeaderAdapter.MyViewHolder> {
    ...
    public RequestHeaderAdapter(@NonNull Context context, View.OnClickListener onClickListener) {
    ...
    public void setCounts(String leave, String shift, String correction, String regularization, String attendance) {
        this.leave = leave;
        this.shift = shift;
