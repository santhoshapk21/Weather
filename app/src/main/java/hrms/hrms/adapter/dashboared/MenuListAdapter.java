...
public class MenuListAdapter extends RecyclerView.Adapter<MenuListAdapter.MyViewHolder> {
    ...
    public MenuListAdapter(@NonNull Context context, String count, String approvalcount, @NonNull View.OnClickListener onClickListener) {
        inflater = LayoutInflater.from(context);
        this.onClickListener = onClickListener;
        this.context = context;
        this.count = count;
        this.approvalcount = approvalcount;
        isManager = ((HomeActivity) context).getBoolean(BaseAppCompactActivity.TYPE.ISMANAGER);
    }
    ...
    public void addApprovalCount(String approvalcount) {
        this.approvalcount=approvalcount;
        notifyDataSetChanged();
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(int position) {
            ...
            if (position == 4) {
                ...
                mBinding.rowHomeTvNotificationCount.setText(approvalcount);
            }
            else if (position == 6) {
                mBinding.rowHomeTvNotificationCount.setVisibility(View.VISIBLE);
                ...
                mBinding.rowHomeTvNotificationCount.setVisibility(View.GONE);
            }
        }
    }
