package hrms.hris365.pickerview.popwindow;
...
import hrms.hris365.pickerview.LoopScrollListener;
import hrms.hris365.pickerview.LoopView;
 ...
 */
public class DatePickerPopYear extends PopupWindow implements OnClickListener {
    ...
    public static class Builder{
        ...
        public DatePickerPopYear build(){
            if(minYear > maxYear){
                throw new IllegalArgumentException();
            }
            return new DatePickerPopYear(this);
        }
    ...
    public DatePickerPopYear(Builder builder){
    ...
    private void initView() {
        ...
        contentView = LayoutInflater.from(mContext).inflate(showDayMonthYear
                ? R.layout.layout_date_picker_inverted_year : R.layout.layout_date_picker, null);
