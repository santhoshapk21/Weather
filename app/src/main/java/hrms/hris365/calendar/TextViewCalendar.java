 ...
 * The Class TextView.
 */
public class TextViewCalendar extends AppCompatTextView {
    ...
    public TextViewCalendar(final Context context) {
        this(context, null);
    }

    public TextViewCalendar(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TextViewCalendar(final Context context, final AttributeSet attrs, final int defStyle) {
